...
describe('Image Registration', () => {
  describe('Submitting an image with invalid inputs', () => {
    ...
    it(`Then I should see "Please type a title for the image" message above the title field`, () => {
      registerForm.elements.titleFeedback().should('contain', 'Please type a title for the image');
    });

    it(`And I should see "Please type a valid URL" message above the imageUrl field`, () => {
      registerForm.elements.urlFeedback().should('contain', 'Please type a valid URL');
    });
  ...
  describe('Submitting an image with valid inputs using enter key', () => {
    ...
    it(`When I enter ${input.url} in the URL field`, () => {
     ...
     it('Then I should see a check icon in the imageUrl fiel', () => {
